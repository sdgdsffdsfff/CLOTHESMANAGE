...
class WarehouseController extends BaseController {
    ...
    public function edit() {
        ...
        $wareHouseData = $wareHouseModel->where($condition)->find();
        $this->assign('data', $wareHouseData);
        $this->display();
    }
    ...
    public function update() {
        ...
        $data['telphone'] = I('post.telephone');
    ...
    public function delete() {
        $proSortProductModel = M('Warehouse');
    ...
    public function json() {
        $wareHouseModel = M('Warehouse');
        $wareHouseData = $wareHouseModel->select();
        $count = $wareHouseModel->count();
        if ($count != 0) {
            $array['total'] = $count;
            $array['rows'] = $wareHouseData;
